...
int main() { 
    ...
    printf("\n\nProcess\t| Arrival Time\t| Start Time\t| End Time\t| Execution Time\t| Waiting Time\t| Turnaround Time\n\n"); 
    ...
    while (over < n) { 
        ...
        printf("p[%d]\t|\t%d\t|\t%d\t|\t%d\t|\t%d\t|\t%d\t|\t%d\n", 
               pr[over], at[over], start, time, bt[over], time - at[over] - bt[over], time - at[over]); 
